class AppConstants {
  ...
  static const String packageName = 'com.cricbid.app';
  ...
  // Sub-Collections (used as: groups/{groupId}/members)
  ...
  static const double pdfPageHeight = 842.0; // A4

  // Excel Column Indices (Teams sheet)
  ...
  // Excel Column Indices (Players sheet)
  ...
  static const int notifyBeforeMatchMins = 120; // 2 hours
