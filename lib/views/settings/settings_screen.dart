import 'package:cricbid/core/theme/theme_service.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _Section(
            ...
            children: [
              ListTile(
                ...
                trailing: Obx(() {
                  final ctrl = Get.find<ThemeService>();
          ...
          Obx(() {
            if (authCtrl.currentRole.value != AppConsts.roleAdmin) {
          ...
          Center(
            child: Text(
              'CricBid v${AppConsts.appVersion}',
