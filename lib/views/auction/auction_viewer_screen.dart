          ...
          if (_showOverlay != null)
            Positioned.fill(child: Obx(() {
              ...
              if (_showOverlay == 'sold' && state != null) {
                return SoldAnimationOverlay(playerName: state.currentPlayerName ?? '', teamName: state.lastTeamName ?? '', points: state.lastPoints ?? 0, playerType: state.currentPlayerType ?? AppConsts.typeBatting);
              }
